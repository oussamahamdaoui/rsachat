...
},{"core-js/fn/regexp/escape":3,"core-js/shim":331,"regenerator-runtime/runtime":333}],3:[function(require,module,exports){
...
var LoggedIn = function LoggedIn() {
  var DomElement = html(_templateObject(), SideBar(), Chat());
  return DomElement;
};
...
var SignUp = function SignUp() {
  ...
  var confirmPasswordElement = Input({
    props: {
      type: 'password',
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<div class=\"alert\">\n    <div class=\"content\">\n      <div class=\"message\">", "</div>\n      <div class=\"buttons\">\n        ", "\n        ", "\n      </div>\n    </div>\n  </div>"]);
...
var Alert = function Alert(_ref) {
  ...
  var DomElement = html(_templateObject(), message, yes ? html(_templateObject2(), yes) : '', no ? html(_templateObject3(), no) : '');
  document.body.appendChild(DomElement);
  return new Promise(function (resolve) {
    if (yes) {
      $('.yes', DomElement).addEventListener('click', function () {
        DomElement.remove();
        resolve(true);
      });
    }
    ...
    if (no) {
      $('.no', DomElement).addEventListener('click', function () {
        DomElement.remove();
        resolve(false);
      });
    }
...
var Chat = function Chat() {
  var DomElement = html(_templateObject(), Input({
    props: {
      type: 'text',
      placeholder: 'Message'
    }
...
var Contacts = function Contacts() {
  ...
  contactListElem.addEventListener('scroll', function () {
    ...
    var firstLetter = sc.innerText[0].toLowerCase();
...
var Icon = function Icon(name) {
  var DomElement = html(_templateObject(), feather.icons[name].toSvg());
  return DomElement;
};
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<div class=\"input\">\n    ", "\n    <input type=", " placeholder=\"", "\">\n  \n  </div>"]);
...
var Input = function Input(_ref) {
  var _ref$props = _ref.props,
      ...
      type = _ref$props$type === void 0 ? 'text' : _ref$props$type,
      _ref$props$placeholde = _ref$props.placeholder,
      placeholder = _ref$props$placeholde === void 0 ? '' : _ref$props$placeholde,
      icon = _ref.icon,
      _ref$onInput = _ref.onInput,
      onInput = _ref$onInput === void 0 ? function () {} : _ref$onInput;
  var DomElement = html(_templateObject(), icon ? Icon(icon) : '', type, placeholder);
  var inputEl = $('input', DomElement);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<div class=\"nav-bar\">\n    <img src=\"/assets/logo.svg\">\n  </div>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<div class=\"side-bar\">\n    ", "\n    ", "\n  </div>"]);
...
var SideBar = function SideBar() {
  var eventManager = new EventManager();
  var DomElement = html(_templateObject(), Contacts(), SideBarShortCuts(eventManager));
  eventManager.subscribe('toggle-open', function () {
...
var SideBarShortCuts = function SideBarShortCuts(eventManager) {
  var DomElement = html(_templateObject(), Icon('users'), Icon('chevron-left'));
  $('.show-all-contacts', DomElement).addEventListener('click', function () {
...
require('babel-polyfill'); // const socketIo = require('socket.io-client');
...
var App = function App() {
  var DomElement = html(_templateObject(), Component);
  return DomElement;
};
...
var routerEvents = require('./GlobalEvents');
...
routerEvents.subscribe('reroute', function (url) {
  ...
  if (routerEvents.current !== ROUTES[rUrl]) {
    ...
    routerEvents.emit.apply(routerEvents, ['rerouted', rUrl, ROUTES[rUrl]].concat(params));
  }
});
module.exports = {
...
var post = function post(baseUrl) {
  return (
    /*#__PURE__*/
    function () {
      var _ref = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(url, data, token) {
        var resp;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetch(new URL(url, baseUrl).href, {
                  method: 'post',
                  headers: {
...
var get = function get(baseUrl) {
  return (
    /*#__PURE__*/
    function () {
      var _ref2 = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(url, token) {
        var resp;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
